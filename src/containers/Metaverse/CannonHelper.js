class CannonHelper {
  ...
  addVisual(body, name, castShadow = false, receiveShadow = true) {
    ...
    if (this.settings === undefined) {
      ...
      this.particleGeo = new THREE.SphereBufferGeometry(1, 16, 8);
    ...
    body.shapes.forEach(function(shape) {
      ...
      switch(shape.type) {
        case CANNON.Shape.types.SPHERE:
          const sphere_geometry = new THREE.SphereBufferGeometry(shape.radius, 8, 8);
        ...
        case CANNON.Shape.types.PLANE:
          geometry = new THREE.PlaneBufferGeometry(100, 100, 4, 4);
        ...
        case CANNON.Shape.types.BOX:
          const box_geometry = new THREE.BoxBufferGeometry(shape.halfExtents.x * 2, shape.halfExtents.y * 2, shape.halfExtents.z * 2);
