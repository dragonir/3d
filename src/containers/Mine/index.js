...
export default class Mine extends React.Component {
    ...
    initThree = () => {
      ...
      class Island {
        constructor(scenesss, params) {
          ...
          this.stoneMaterial = new THREE.MeshLambertMaterial({
            color: 0x9eaeac
          });
        }
        drawGround() {
      ...
      // Generate Island
      const island = new Island(scene.scene, {
        x: 0,
        y: 0,
        z: 0,
        herbs: 10
      ...
      const island2 = new Island(scene.scene, {
        x: 25,
        y: -40,
        z: -70,
        herbs: 10
      ...
      island2.init();
      const bblock2 = new Bblock(scene.scene, {
        x: 25,
        y: -40,
        z: -70,
        herbs: 10
      ...
      const island3 = new Island(scene.scene, {
        x: -70,
        y: 20,
        z: -100,
        herbs: 10
      ...
      island3.init();
      const bblock3 = new Bblock(scene.scene, {
        x: -70,
        y: 20,
        z: -100,
        herbs: 10
  ...
  render () {
    return (
      <div className='demo'>
        <canvas className='webgl' data-canvas></canvas>
